...
[TestClass]
[TestSubject(typeof(TraditionalDictionary))]
public class TraditionalDictionaryTest
{
    private TraditionalDictionary dictionary = null;
    
    [TestInitialize()]
    public void Startup()
    {
        this.dictionary = new TraditionalDictionary();
    }
    ...
    public void IncompatibleListsLength()
    {
        ...
        var result = this.dictionary.GetDictionary(keys:keys, values:values);
    }
